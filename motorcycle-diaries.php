...
<html>
<head>
<title>The Motorcycle Diaries  | BookLand</title>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">The Motorcycle Diaries</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
			...
			<div class="col-md-8 single-left">
				<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/14a.jpg">
								<div class="thumb-image"> <img src="images/14a.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/14b.jpg">
								 <div class="thumb-image"> <img src="images/14b.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
						</ul>
					</div>
					<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					<h3>The Motorcycle Diaries</h3>
					<h4><span class="item_price">&#8377 235</span></h4>
					<div class="rating1">
