...
<html>
<head>
<title>Travelling to Infinity  | BookLand</title>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Travelling to Infinity</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
			...
			<div class="col-md-8 single-left">
				<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/16a.jpg">
								<div class="thumb-image"> <img src="images/16a.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/16b.jpg">
								 <div class="thumb-image"> <img src="images/16b.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
						</ul>
					</div>
					<!-- flixslider -->
