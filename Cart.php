...
$_SESSION['cart'] = array();
	...
	if(isset($_GET['submit']))
	{
			...
			$q = "select * from books where bid = $bid";
		...
		$itemArray = array($items[0][0]=>array('bid' => $items[0][0], 'title'=>$items[0][1], 'quant' => $_GET["quantity"], 'price'=>$items[0][2], 'image'=> $items[0][3]));
	...
	//{
		//<a href = 'CheckOut.php' target = 'myframe'><Button class = 'Addtocart'> Check Out </button> </a>
			...
			<div class="checkout-right animated wow slideInUp" data-wow-delay=".5s">
				...
				<?php 
					...
					<tr class="rem">   
						...
						<td class="invert-image"><img src="<?php echo ($item['image']);?>" height="120" width="100"/></td>
						<td class="invert"><?php echo $item['quant'];?></td>
						<td class="invert"><?php echo $item['title'];?></td>
						<td class="invert">&#8377 <?php echo (0.05*($item['price']));?></td>
						<td class="invert">&#8377 <?php echo $item['price'];?></td>
						<td class="invert"><a href ="Cart.php?action&id=<?php echo $i; ?>"><img src = "images/trash.jpg" width="42" height="42"></a></td>
					</tr>
					<?php }$d=$c;}  $gst = (0.05*$tp2);?>
													
				</table>
			</div>
			<div class="checkout-left">	
				<div class="checkout-left-basket animated wow slideInLeft" data-wow-delay=".5s">
					<h4>Bill <tabs> Summary</h4>
					<ul>
						<li> <i>Sub-Total: </i> <span>&#8377 <?php echo $tp2; ?> </span></li>
						<li><i>GST: </i> <span>&#8377 <?php echo $gst; ?></span></li>
						<li><i>Total: </i> <span>&#8377 <?php echo ($tp2+$gst);   ?> </span></li>
					</ul>
				</div>
				<form action="checkout.php">
				<div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s"><?php if(!empty($_SESSION['cart'])) { ?>
				<button class="button" style="vertical-align:middle" type="submit"><span>CHECKOUT</span></form></a></button><?php } else { ?>
				<button class="button9 disabled">CHECKOUT</button><?php } ?>
				</div>
