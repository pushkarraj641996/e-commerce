...
<html>
<head>
<title>My Orders | BookLand</title>
...
<!-- //breadcrumbs -->
	...
	<div class="checkout">
		<div class="container">
			<h3 class="animated wow slideInLeft" data-wow-delay=".5s">My Orders :<span></span></h3>
			...
			<table>
				...
				<tr>
					...
					<td><a href ="<?php echo "viewcart.php?id=$row[0]&em=$row[12]";?>"><img src = "images/go.jpg" width="42" height="42"></a></td>
				</tr>
				<?php } ?>
			</table>
			</div>
