...
<html>
<head>
<title>The Fault in Our Stars | BookLand</title>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">The Fault in Our Stars</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
			...
			<div class="col-md-8 single-left">
				<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/10a.jpg">
								<div class="thumb-image"> <img src="images/10a.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/10b.jpg">
								 <div class="thumb-image"> <img src="images/10b.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
						</ul>
					</div>
					<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					...
					<h4><span class="item_price">&#8377 190</span></h4>
					<div class="rating1">
